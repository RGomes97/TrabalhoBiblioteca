...
1- clone o projeto = git clone url_do_projeto

2- Execute o sql no banco de dados Mysql do arquivo createDbTrabalhoBibliotecaPopulada.sql 
na raiz do WebJavaProject.
